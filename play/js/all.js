$(function () {
    ...
    $('nav .nav div:nth-of-type(2) li:nth-of-type(1)').on('click', function () {
        window.open('play-new.html', '_self');
    });
    $('nav .nav div:nth-of-type(2) li:nth-of-type(2)').on('click', function () {
        window.open('play-hot.html', '_self');
    });
    $('nav .nav div:nth-of-type(2) li:nth-of-type(3)').on('click', function () {
        window.open('play-class.html', '_self');
    });
