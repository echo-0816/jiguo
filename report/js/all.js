$(function () {
    ...
    // 自己页面 2
    $('.report-hot div a:nth-of-type(1)').on('click', function () {
        window.open('report-new.html', '_self');
    });
    $('.report-new div a:nth-of-type(2)').on('click', function () {
        window.open('report-hot.html', '_self');
    });
})